...
## Deliverables:
* **Main Report:** You can view the complete detailed report document here: [SOC Open Redirect Report](SOC_Detection_and_Response_Playbook_Open_Redirect_Report.pdf)
* **Detection Rule:** Splunk SPL query for catching external redirect payloads:
  source="juice_shop_access.log" "Unrecognized target URL for redirect"
| regex _raw="(?i)redirect:\s*https?:\/\/(?!(github\.com))"
